...
const HomePage = () => {
  return (
    <section className="flex flex-col justify-center items-center bg-indigo-200 shadow-lg shadow-indigo-500/40 hover:shadow-indigo-500 p-8 border rounded-lg my-4">
