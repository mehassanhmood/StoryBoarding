...
const HomePage = () => {
  return (
    <section className="flex flex-col justify-center items-center bg-indigo-200 shadow-lg hover:shadow-indigo-900 p-6 md:p-12 border rounded-lg my-4 mx-2 md:mx-8">
