...
const CostIncrease = () => {
  ...
  return (
    <div className="p-4 border rounded-lg shadow-md bg-teal-100 text-center"> {/* Added text-center for centering text */}
      ...
      <img 
        src={housingPrice}  
        className={`max-w-full h-auto rounded-md mb-4 transition-opacity duration-700 ${fadeIn ? 'opacity-100' : 'opacity-0'}`} // Fade-in effect
      />
      <p>
